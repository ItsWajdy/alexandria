...
void main() {
  ...
  group('AddBookBloc', () {
    ...
    AddBookBloc buildBloc() {
      return AddBookBloc(allBooksCubit, booksRepository);
    }
    ...
    group('constructor', () {
      ...
      test('has correct initial state', () {
        expect(
          buildBloc().state,
          equals(const AbstractState()),
        );
      });
    });

    group('TitleChanged', () {
      blocTest<AddBookBloc, AbstractState>(
    ...
    group('FormSubmitted', () {
      blocTest<AddBookBloc, AbstractState>(
        'calls the addNewBook method in repository',
        build: buildBloc,
        seed: () => AbstractState(
          bookId: null,
          title: Text.dirty(mockBook.title),
        ...
        verify: (_) {
          verify(() => booksRepository.addNewBook(
              title: any(named: 'title'),
              author: any(named: 'author'),
              description: any(named: 'description'),
              image: any(named: 'image'),
